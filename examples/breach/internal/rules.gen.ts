...
export const CATALOGUE: CardDef[] = [
	...
	},
	{
		ability: {
			...
			noise: 1,
			dc: 8,
			targets: ['forum', 'archive', 'hut', 'house'],
	...
	},
	{
		ability: {
			...
			noise: 2,
			dc: 9,
			targets: ['forum', 'archive', 'mark', 'precinct'],
			text: 'No years of patches. One convincing login page and a code the owner reads aloud.',
		},
		owner: 'maintainer',
		side: 'red',
		copies: 2
	},
	{
		ability: {
			...
			mod: 2,
			noise: 1,
			targets: ['mill', 'house', 'forge', 'mark'],
			text: 'Publish the internal package name publicly, at a higher version. The resolver does the rest.',
		},
		owner: 'maintainer',
		side: 'red',
		copies: 2
	},
	{
		ability: {
			...
			mod: 1,
			noise: 1,
			targets: ['precinct', 'forge', 'mark', 'forum'],
			text: 'It was a good plugin with fifty thousand installs. Then somebody bought it.',
		},
		owner: 'maintainer',
		side: 'red',
		copies: 2
	...
	},
	{
		ability: {
			...
			mod: 1,
			noise: 0,
			targets: ['forum', 'house', 'mill', 'archive', 'hut', 'precinct', 'forge', 'silos', 'redoubt', 'checkpoint', 'keep'],
			text: 'Dormant and inert. Cannot be found by a sweep — there is nothing running to find.',
		},
		owner: 'state',
		side: 'red',
		copies: 2
	},
	{
		ability: {
			key: 'harvest',
			name: 'Harvest the Runner',
			kind: 'strike',
			skill: 'tech',
			ap: 2,
			mod: 3,
			noise: 2,
			targets: ['forge', 'hut', 'precinct', 'keep'],
			text: 'The build has every credential the pipeline owns, and it prints them when asked. Steal the tokens, not the code.',
		},
		owner: 'state',
		side: 'red',
		copies: 2
	},
	{
		ability: {
			...
			mod: 2,
			noise: 2,
			targets: ['redoubt', 'keep', 'silos', 'archive', 'checkpoint'],
			text: 'The payload has what it came for. All that is left is a DNS query nobody reads.',
		},
		owner: 'state',
		side: 'red',
		copies: 2
	...
	},
	{
		ability: {
			...
			noise: 2,
			dc: 10,
			targets: ['precinct', 'keep', 'mark'],
			text: 'Cheaper than a zero-day, and it comes with a badge.',
		},
		owner: 'state',
		side: 'red',
		copies: 2
	},
	{
		ability: {
			...
			dc: 8,
			targets: ['observatory'],
			text: 'Feed them an actor they will believe. The next look at this region is a look at the wrong region.',
		},
		owner: 'state',
		side: 'red',
		copies: 1
	},
	{
		ability: {
			...
			noise: 0,
			targets: ['bastion'],
			text: 'One waiver, filed correctly, and the map stops showing the thing that is there.',
		},
		owner: 'state',
		side: 'red',
		copies: 1
	...
	},
	{
		ability: {
			...
			noise: 0,
			dc: 8,
			targets: ['archive', 'forum', 'hut', 'silos'],
			on: ['blue', 'neutral'],
			text: 'Nothing lands on the say-so of one account. The helpful newcomer needs a second helpful newcomer.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 8,
			targets: ['forge', 'hut', 'keep', 'redoubt'],
			on: ['blue'],
			text: 'The token is minted for this job and dead before the next one. Stealing it buys ninety seconds.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 8,
			targets: ['forge', 'redoubt', 'checkpoint', 'precinct', 'hut'],
			on: ['blue'],
			text: 'Name every host this thing may talk to. There will be four, and it will hate you.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 8,
			targets: ['archive', 'precinct', 'keep', 'forge'],
			on: ['blue'],
			text: 'The key will not sign for a domain it has never seen. There is no code to read aloud.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 9,
			targets: ['checkpoint', 'court', 'keep', 'silos'],
			on: ['blue'],
			text: 'Distrust the authority, not the certificate. Everything it ever signed is unsigned, and the wall goes back up.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 9,
			targets: ['forum', 'mark', 'house'],
			on: ['neutral'],
			text: 'You cannot fix their project. You can stop it being on the critical path.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 1
	},
	{
		ability: {
			...
			noise: 0,
			dc: 8,
			targets: ['forge', 'silos', 'mill', 'court'],
			on: ['blue'],
			text: 'Throw the artifact away and make it again from readable source. Whatever was hiding in it does not survive the trip.',
		},
		owner: 'architect',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 9,
			targets: ['forge', 'silos', 'court', 'redoubt'],
			on: ['blue'],
	...
	},
	{
		ability: {
			...
			noise: 0,
			dc: 7,
			targets: ['archive', 'precinct', 'hut', 'forge', 'silos', 'mill', 'court', 'checkpoint', 'keep', 'bastion', 'redoubt', 'house'],
			on: ['blue', 'neutral'],
	...
	},
	{
		ability: {
			...
			noise: 0,
			dc: 9,
			targets: ['silos', 'forge', 'house', 'mill', 'archive', 'forum'],
			on: ['blue', 'neutral'],
	...
	},
	{
		ability: {
			...
			noise: 0,
			dc: 8,
			targets: ['archive', 'silos', 'mill', 'house', 'redoubt', 'precinct', 'forge', 'bastion'],
			on: ['blue', 'neutral'],
			text: 'Not what is running — what is there. A sleeper is inert, and inert things sit still for a scanner.',
		},
		owner: 'hunter',
		side: 'blue',
		copies: 2
	},
	{
		ability: {
			...
			noise: 0,
			dc: 7,
			targets: ['mill', 'silos', 'redoubt', 'house'],
			on: ['blue', 'neutral'],
			text: 'An SBOM is boring until the morning somebody asks whether you are running it.',
		},
		owner: 'hunter',
		side: 'blue',
		copies: 2
