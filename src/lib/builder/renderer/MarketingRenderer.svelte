<script lang="ts">
	...
	import PageHero from '../../primitives/cards/PageHero.svelte';
	import ClosingCTA from '../../primitives/cards/ClosingCTA.svelte';
	import FaqAccordion from '../../display/content/FaqAccordion.svelte';
