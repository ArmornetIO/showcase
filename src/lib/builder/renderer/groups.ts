...
import ShapesRenderer from './ShapesRenderer.svelte';
...
export const RENDER_GROUPS: readonly RenderGroup[] = [
	{
		// Its own group rather than more branches in `primitives`: these are the
		// family backed by no library component at all — raw SVG and one <img>
		// where every other branch renders a component — and they share a
		// stroke/fill/opacity vocabulary nothing else uses.
		id: 'shapes',
		label: 'Shapes & media',
		file: 'ShapesRenderer.svelte',
		component: ShapesRenderer,
		ids: ['Rectangle', 'Ellipse', 'Line', 'Image']
	},
	{
		id: 'primitives',
		label: 'Primitives',
	...
	},
	{
		...
		ids: ['DataTable', 'Timeline', 'Sparkline', 'Chart', 'DonutChart', 'CollapsibleStack']
	},
	{
		id: 'display',
		label: 'Display',
	...
	},
	{
		...
		ids: ['SegmentGroup', 'RadioList', 'CheckboxList', 'StepSwitcher']
	},
	{
		id: 'storyboard',
		label: 'Storyboard',
