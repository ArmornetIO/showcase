...
export const COMP_FILES: Record<string, string> = {
	Button: 'src/lib/primitives/actions/Button.svelte',
	IconButton: 'src/lib/primitives/actions/IconButton.svelte',
	Chip: 'src/lib/primitives/status/Chip.svelte',
	Card: 'src/lib/primitives/cards/Card.svelte',
	Toggle: 'src/lib/primitives/forms/Toggle.svelte',
	Input: 'src/lib/primitives/forms/Input.svelte',
	Textarea: 'src/lib/primitives/forms/Textarea.svelte',
	SearchInput: 'src/lib/primitives/forms/SearchInput.svelte',
	Select: 'src/lib/primitives/forms/Select.svelte',
	Panel: 'src/lib/primitives/chrome/Panel.svelte',
	Tabs: 'src/lib/navigation/Tabs.svelte',
	ActionBar: 'src/lib/primitives/actions/ActionBar.svelte',
