	...
	<div class="px-5 py-3 shrink-0 border-b border-[var(--border)] bg-[linear-gradient(90deg,var(--accent-line),transparent)]">
		...
		<div class="flex items-center gap-[12px]">
			...
			<div class="flex-1 min-w-0">
				...
				<div
					class="inline-flex items-center gap-[6px] px-2 py-[3px] border rounded-[2px] font-[var(--mono)] text-[0.5rem] tracking-[0.2em]"
			...
			<!-- Close button -->
			<button
				class="w-[28px] h-[28px] shrink-0 flex items-center justify-center border border-[var(--border-accent)] rounded-[2px] bg-[var(--bg)] text-[var(--fg-muted)] font-[var(--mono)] text-[1rem] font-bold leading-none cursor-pointer p-0 transition-[color,border-color,background] duration-[150ms] hover:text-[var(--type-accent)] hover:border-[var(--type-accent)] hover:bg-[var(--type-accent-faint)] active:scale-[0.92]"
				onclick={onclose}
		...
		<div class="flex items-center gap-[8px] mt-[10px] pl-[44px]">
			...
			{#if !titleIsId && nodeId}
				<button
					class="ml-auto shrink-0 flex items-center gap-[5px] px-2 py-[3px] border rounded-[2px] bg-transparent font-[var(--mono)] text-[0.5625rem] tracking-[0.1em] cursor-pointer transition-[color,border-color] duration-[150ms] {copied
...
<style>
	...
	.dc-content::-webkit-scrollbar-thumb { background: var(--border-accent); border-radius: 3px; }
