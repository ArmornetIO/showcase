...
>
	{#each items as item (item.label)}
		...
		<div
			class="relative p-[18px_22px] border border-[var(--sc-border)] r-inset bg-[var(--sc-bg)] shadow-[var(--sc-shadow)] transition-[border-color,box-shadow] duration-[250ms] ease-in-out select-none hover:border-[var(--sc-border-hover)] hover:shadow-[var(--sc-shadow-hover)]"
