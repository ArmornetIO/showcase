<script lang="ts">
	...
	const OUTER =
		'M100 3 L192 42 L192 117 C192 152 155 205 100 217 C45 205 8 152 8 117 L8 42 Z';
	const FRAME_MID =
		'M100 8 L187 45 L187 117 C187 151 152 201 100 212 C48 201 13 151 13 117 L13 45 Z';
	const FRAME_IN =
		'M100 13 L183 48 L183 117 C183 150 150 197 100 207 C50 197 17 150 17 117 L17 48 Z';
	const RIM = 'M100 27 L170 56 L170 117 C170 147 144 180 100 190 C56 180 30 147 30 117 L30 56 Z';
