<script module lang="ts">
	export const ICONS = {
		...
		shapes:
			'<path d="M8.3 10a.7.7 0 0 1-.626-1.079L11.4 3a.7.7 0 0 1 1.199-.043L16.3 8.9a.7.7 0 0 1-.572 1.1Z"/><rect x="3" y="14" width="7" height="7" rx="1"/><circle cx="17.5" cy="17.5" r="3.5"/>',
		...
		// ── Security & identity ────────────────────────────────────────────────
		// The Armornet mark, cut down to one stroke weight so it reads at 16px.
		// The full two-tone crest (bloom + mesh footprint) is ArmornetCrest.svelte.
		// The right bar joint is lifted and both legs kick outward below their
		// joint — same deliberate imperfection as the full crest.
		armornet:
			'<path d="M12 2.4 20 5.6v7c0 4.3-3.4 7.2-8 8.6-4.6-1.4-8-4.3-8-8.6v-7z"/><path d="M12 7.4 9.87 12.8 8.35 16"/><path d="M12 7.4 14 12.45 15.62 16"/><path d="M9.87 12.8 14 12.45"/><circle cx="12" cy="7.4" r=".95" fill="currentColor" stroke="none"/><circle cx="8.35" cy="16" r=".95" fill="currentColor" stroke="none"/><circle cx="15.62" cy="16" r=".95" fill="currentColor" stroke="none"/><circle cx="9.87" cy="12.8" r=".72" fill="currentColor" stroke="none"/><circle cx="14" cy="12.45" r=".72" fill="currentColor" stroke="none"/>',
		shield:
		...
		key: '<path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4"/><path d="m21 2-9.6 9.6"/><circle cx="7.5" cy="15.5" r="5.5"/><path d="M11.1 11.9 7 16"/>',
		fingerprint:
			'<path d="M12 10a2 2 0 0 0-2 2c0 1.02-.1 2.51-.26 4"/><path d="M14 13.12c0 2.38 0 6.38-1 8.88"/><path d="M17.29 21.02c.12-.6.43-2.3.5-3.02"/><path d="M2 12a10 10 0 0 1 18-6"/><path d="M2 17.5c3.16-1.65 5.78-5 6-8.5"/><path d="M20 12c0 1.9-.18 3.74-.5 5.5"/><path d="M9 15.49C9.15 12 9 8 7.93 6"/><path d="M4.93 9C3.16 12 2 15.02 2 17.5"/>',
		...
		'flask-conical':
			'<path d="M14 2v6l3.7 6.8A2 2 0 0 1 16 18H8a2 2 0 0 1-1.7-3.2L10 8V2"/><path d="M6.7 15H17"/><path d="M8 2h8"/>',
		...
		// ── Custom: mesh topology (5-node diamond) ─────────────────────────────
		mesh: '<circle cx="12" cy="4" r="2"/><circle cx="12" cy="20" r="2"/><circle cx="4" cy="12" r="2"/><circle cx="20" cy="12" r="2"/><circle cx="12" cy="12" r="2.5"/><path d="M12 9.5V6M12 14.5V18M9.5 12H6M14.5 12H18"/>'
	} as const;
...
<script lang="ts">
	...
	let { name, size = 20, strokeWidth = 1.5, class: cls = '', style = '' }: IconProps = $props();
</script>
