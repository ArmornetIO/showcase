...
//
// The mode list, labels, colours and glyph choices come from agent/modes.yaml
// via modes.gen.ts — add a mode there and it appears here. The SVG paths below
// are hand-drawn design work and are deliberately NOT generated; a new mode
// renders with no silhouette until someone draws one.
 ...
 *  because SVG paths are design work. Keyed by mode key from agent/modes.yaml.
...
const MODE_GLYPHS: Record<string, IconOpt[]> = {
	...
	dep_analysis: [
		{ name: 'Package', svg: `<path d="M12 2.5 4 6.5v9l8 4 8-4v-9z"/><path d="M4 6.5l8 4 8-4M12 10.5v9"/>` },
		{ name: 'Dep graph', svg: `<circle cx="6" cy="6.5" r="2"/><circle cx="18" cy="7.5" r="2"/><circle cx="8.5" cy="18" r="2"/><circle cx="17" cy="17" r="2"/><path d="M7.7 8 8 16M8 6.8 16 7.4M10.5 17.6 15 17.2M18 9.5v5.5"/>` },
		{ name: 'Hierarchy', svg: `<rect x="9" y="3" width="6" height="4" rx="1"/><rect x="3" y="16" width="6" height="4" rx="1"/><rect x="15" y="16" width="6" height="4" rx="1"/><path d="M12 7v3M6 16v-3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v3"/>` },
		{ name: 'Branch', svg: `<circle cx="7" cy="6" r="2"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="9" r="2"/><path d="M7 8v8M7 12h3.5a3 3 0 0 0 3-3v-.2"/>` },
		{ name: 'Layers', svg: `<path d="M12 3 21 8 12 13 3 8z"/><path d="M3 12 12 17 21 12M3 16 12 21 21 16"/>` },
		{ name: 'Shield tree', svg: `<path d="M12 3 20 6v5c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6z"/><path d="M12 17.5V7M12 12.5 9 9M12 12.5 15 9"/><circle cx="9" cy="9" r="1"/><circle cx="15" cy="9" r="1"/><circle cx="12" cy="7" r="1"/>` },
		{ name: 'Merkle', svg: `<rect x="10" y="3" width="4" height="3.2" rx=".6"/><rect x="5" y="9.5" width="4" height="3.2" rx=".6"/><rect x="15" y="9.5" width="4" height="3.2" rx=".6"/><rect x="3" y="17" width="3" height="2.6" rx=".5"/><rect x="8" y="17" width="3" height="2.6" rx=".5"/><rect x="13" y="17" width="3" height="2.6" rx=".5"/><rect x="18" y="17" width="3" height="2.6" rx=".5"/><path d="M12 6.2 7 9.5M12 6.2 17 9.5M7 12.7 4.5 17M7 12.7 9.5 17M17 12.7 14.5 17M17 12.7 19.5 17"/>` },
		{ name: 'Rooted', svg: `<path d="M12 8v8"/><path d="M12 8 8 4.5M12 8 16 4.5M12 10.5 9 8M12 10.5 15 8"/><path d="M12 16 8 19.5M12 16 16 19.5M12 13.5 9 16M12 13.5 15 16"/>` },
		{ name: 'Conifer', svg: `<path d="M12 3 8.5 8h7z"/><path d="M12 6 7 12h10z"/><path d="M12 10 5.5 17h13z"/><path d="M12 17v3M10 20h4"/>` },
		{ name: 'Bough', svg: `<path d="M12 3 20 6v5c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6z"/><path d="M8.5 17C9 12 11 9 15.5 7.5"/><circle cx="11" cy="11.5" r="1"/><circle cx="13.5" cy="9.2" r="1"/><path d="M10 13.5 9 12.5M12.4 10.8 11.3 10"/>` },
		{ name: 'Scan tree', svg: `<circle cx="10.5" cy="10.5" r="6.5"/><path d="M15.1 15.1 20 20"/><path d="M10.3 6.6 7.8 9.2M10.7 6.6 13.2 9.2M7.4 10.8 6.7 13M7.8 10.8 8.9 13M13.2 10.8 12.1 13M13.6 10.8 14.3 13"/><rect x="9.7" y="5" width="1.6" height="1.6" rx=".3"/><rect x="6.8" y="9.2" width="1.6" height="1.6" rx=".3"/><rect x="12.6" y="9.2" width="1.6" height="1.6" rx=".3"/><rect x="5.8" y="13" width="1.6" height="1.6" rx=".3"/><rect x="8.2" y="13" width="1.6" height="1.6" rx=".3"/><rect x="11.2" y="13" width="1.6" height="1.6" rx=".3"/><rect x="13.6" y="13" width="1.6" height="1.6" rx=".3"/>` },
	],
	github_runner: [
...
/** Mode icons = generated metadata (agent/modes.yaml) + hand-drawn options above.
...
// back to the Terminal glyph (hello_world, intelligence, dep_analysis, language).
 ...
 *  Generated from agent/modes.yaml — edit the manifest, not this. Modes with an
 ...
 *  Generated from agent/modes.yaml — edit the manifest, not this. */
