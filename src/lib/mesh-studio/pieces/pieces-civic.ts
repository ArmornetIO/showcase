...
// Seven more solids for the globe, in the same language `pieces.ts` set out: a
...
//
// The seven belong to one settlement, and that is a constraint rather than a
...
// between them, a needle, a descending cascade, an hourglass, a hut. Those seven
// outlines are different as black shapes, which is the only test that matters.
...
export const CIVIC_MODE_PIECES: Record<string, string> = {
	intelligence: 'observatory',
	language: 'court',
	harness: 'forum',
	momus: 'beacon',
	feed_content_analysis: 'mill',
	vendor_identification: 'mark',
	hello_world: 'hut',
};
