...
<style>
	...
	.rich-card {
		...
		/* Surface comes from the shared `.glass` (see the markup). The old fixed
		   navy gradient painted itself dark in every theme. */
