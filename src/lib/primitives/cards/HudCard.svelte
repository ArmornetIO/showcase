...
<div
	class="relative overflow-hidden rounded-[3px] border p-7 pr-8 transition-[border-color,box-shadow] duration-[250ms] {featured ? 'border-[var(--border-feat)] shadow-[var(--shadow-feat)]' : 'border-[var(--border)]'} {cls}"
