<script lang="ts">
	...
	const compareRows: CompareRow[] = [
		...
		{ type: 'feature', feature: 'OpAMP control plane', values: { starter: { type: 'check', on: false }, team: { type: 'check', on: false }, enterprise: { type: 'check', on: true } } },
